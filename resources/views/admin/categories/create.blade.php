            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6">
                ...
                <form action="{{ route('categories.store') }}" method="POST">
                    ...
                    <div class="mt-6 flex justify-end gap-x-2">
                        ...
                        <button type="submit" class="py-2 px-3 inline-flex items-center text-sm font-semibold rounded-lg border border-transparent bg-indigo-600 text hover:bg-indigo-700">
                            Enregistrer
                        </button>
                    </div>
                </form>
